...
# Length of overlaps between TEs, DNase peaks
TE_DNase_overlap = dcast(TE_DNase_peaks,chromosome+start+stop+subfamily+family+class+strand~Sample,value.var="Overlap")
TE_DNase_overlap[is.na(TE_DNase_overlap)] = 0
TE_DNase_overlap$class_update = convert_class(TE_DNase_overlap$class)
...
save(list=c("TE_DNase_peaks","TE_DNase_overlap"),file="R_datasets/TE_DNase_peaks.RData")