...
colnames(feature_metric_mean) = c("Metric","Feature","Enrichment")
feature_metric_mean$Feature = factor(feature_metric_mean$Feature,levels=levels(feature_metric_mean$Feature)[c(17,19,18,5,7,6,8:9,2,4,3,10,12,11,14,16,15,13,1,20)])
...
colnames(feature_metric_mean_class) = c("Class","Metric","Feature","Enrichment")
feature_metric_mean_class$Feature = factor(feature_metric_mean_class$Feature,levels=levels(feature_metric_mean_class$Feature)[c(17,19,18,5,7,6,8:9,2,4,3,10,12,11,14,16,15,13,1,20)])
