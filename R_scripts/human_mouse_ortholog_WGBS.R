...
human_mouse_orthologs_mm10_category[,20:32] = apply(human_mouse_orthologs_mm10[,29:41],2,function(x) ifelse(x > 0.7,"Hypermethylated",ifelse(x < 0.3,"Hypomethylated",ifelse(x <= 0.7 & x >= 0.3,"Intermediate","NA"))))
human_mouse_orthologs_mm10_category[,33:41] = apply(human_mouse_orthologs_mm10[,20:28],2,function(x) ifelse(x > 70,"Hypermethylated",ifelse(x < 30,"Hypomethylated",ifelse(x <= 70 & x >= 30,"Intermediate","NA"))))
