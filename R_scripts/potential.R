...
RNA_potential_cum$State = rep("Expression",sample_counts["All","RNA"])
...
RNA_potential_noCancer_cum$State = rep("Expression",sample_counts["Include","RNA"])
...
RNA_RPKM_sample$State = rep("Expression",sample_counts["All","RNA"])
