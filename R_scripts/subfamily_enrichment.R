...
subfamily_state_sample_members$Percent = subfamily_state_sample_members$Members/ifelse(metadata[match(subfamily_state_sample_members$Sample,metadata$Sample),]$chrY == "Yes",
                                                                                       rmsk_TE_subfamily[match(subfamily_state_sample_members$subfamily,rmsk_TE_subfamily$subfamily),]$Count,
                                                                                       rmsk_TE_subfamily[match(subfamily_state_sample_members$subfamily,rmsk_TE_subfamily$subfamily),]$Count_noY)
...
subfamily_DNase_sample$Length_k = ifelse(metadata[match(subfamily_DNase_sample$Sample,metadata$Sample),]$chrY == "Yes",GENOME_WIDTH,GENOME_WIDTH_noY)
...
TE_DNase_peaks_members$Count = ifelse(metadata[match(TE_DNase_peaks_members$Sample,metadata$Sample),]$chrY == "Yes",
                                      rmsk_TE_subfamily[match(TE_DNase_peaks_members$subfamily,rmsk_TE_subfamily$subfamily),]$Count,
                                      rmsk_TE_subfamily[match(TE_DNase_peaks_members$subfamily,rmsk_TE_subfamily$subfamily),]$Count_noY)
...
# Total length of sample
subfamily_H3K27ac_sample$Length_k = ifelse(metadata[match(subfamily_H3K27ac_sample$Sample,metadata$Sample),]$chrY == "Yes",GENOME_WIDTH,GENOME_WIDTH_noY)
...
TE_H3K27ac_peaks_members$Count = ifelse(metadata[match(TE_H3K27ac_peaks_members$Sample,metadata$Sample),]$chrY == "Yes",
                                      rmsk_TE_subfamily[match(TE_H3K27ac_peaks_members$subfamily,rmsk_TE_subfamily$subfamily),]$Count,
                                      rmsk_TE_subfamily[match(TE_H3K27ac_peaks_members$subfamily,rmsk_TE_subfamily$subfamily),]$Count_noY)
