...
# Basic potential control statistics
...
head(enhancer_matrix_pca$rotation[order(enhancer_matrix_pca$rotation),])
tail(enhancer_matrix_pca$rotation[order(enhancer_matrix_pca$rotation),])
```
...
# Max by state
lapply(c(chromHMM_states,meth_states,"DNase","H3K27ac"),function(x) tail(subfamily_state_sample_filter[which(subfamily_state_sample_filter$Enrichment > THRESHOLD_LOR & subfamily_state_sample_filter$State == x),][order(subfamily_state_sample_filter[which(subfamily_state_sample_filter$Enrichment > THRESHOLD_LOR & subfamily_state_sample_filter$State == x),]$Percent),],n=10))
```
