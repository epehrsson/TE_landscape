...
grid.arrange(a,b,c,nrow=2,layout_matrix=rbind(c(1,2),c(3,3)))
```
...
grid.arrange(a,b,heights=c(0.4,0.6))
```
...
```{r Figure 6, echo=FALSE, cache=TRUE, dependson=c("Figure 1","Figure 2","Figure S6","setup","load libraries","set plot parameters","load functions","create essential matrices","load metadata","load essential matrices","define vectors","define facet labels","load feature sizes","calculate TE stats"),eval=FALSE}
#source("R_scripts/potential.R")
source("R_scripts/TE_correlation.R")
...
```{r Figure S12, echo=FALSE, cache=TRUE, cache.lazy=FALSE, dependson=c("Figure 3","setup","load libraries","set plot parameters","load functions","create essential matrices","load metadata","load essential matrices","define vectors","define facet labels","load feature sizes","calculate TE stats"),eval=FALSE}
...
```{r max expression by feature,eval=FALSE}
...
```{r Figure S13, echo=FALSE, cache=TRUE, dependson=c("Figure 3","Figure S8","setup","load libraries","set plot parameters","load functions","create essential matrices","load metadata","load essential matrices","define vectors","define facet labels","load feature sizes","calculate TE stats"),eval=FALSE}
#source("R_scripts/TE_class_stats.R")
#source("R_scripts/TE_correlation.R")
...
```{r Figure S14, echo=FALSE,eval=FALSE}
#source("R_scripts/state_metric_correlation.R")
...
```{r analysis Fig S10b,eval=FALSE}
# From Figure S10
...
```{r potential by chromosome,eval=FALSE}
...
```{r Figure S15, echo=FALSE,eval=FALSE}
#source("R_scripts/TE_subfamily_stats.R")
...
```{r young subfamilies,eval=FALSE}
