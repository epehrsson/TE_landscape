...
knitr::opts_chunk$set(fig.width=7, fig.height=8, fig.path='TE_landscape_draft_figures/', cache.path="TE_landscape_draft_cache/",error=TRUE)
```
...
ddply(chromHMM_TE_state,.(Category),summarise,Mean=mean(Max_states_intra),SD=sd(Max_states_intra),Median(Max_states_intra),IQR(Max_states_intra))
ddply(chromHMM_TE_state,.(class_update,Category),summarise,Count=length(Max_states_intra),Mean=mean(Max_states_intra),SD=sd(Max_states_intra),Median(Max_states_intra),IQR(Max_states_intra))
...
aggregate(data=rmsk_TE_subfamily_measure[,c("class_update",all_pc_states)],.~class_update,function(x) median(na.omit(x)),na.action = na.pass)
...
e = ggplot(chr_state_DNase_total,aes(x=Size,y=Peaks,color=chromosome,label=chromosome)) + geom_point() + geom_text() + scale_color_discrete(guide=FALSE) + geom_smooth(method='lm',se=FALSE,color="black",linetype="dashed") + ylab("Chromosome size")

f = ggplot(chr_state_H3K27ac_total,aes(x=Size,y=Peaks,color=chromosome,label=chromosome)) + geom_point() + geom_text() + scale_color_discrete(guide=FALSE) + geom_smooth(method='lm',se=FALSE,color="black",linetype="dashed") + ylab("Chromosome size")
...
state_freq = ddply(human_mouse_orthologs_WGBS_paired,.(Human_state_WGBS),summarise,Entries=100*length(Human_state_WGBS)/dim(human_mouse_orthologs_WGBS_paired)[1])

b = ggplot(human_mouse_orthologs_WGBS_paired,aes(x=Human_state_WGBS,fill=Mouse_state_WGBS)) + geom_bar(position="fill") + scale_fill_manual(values=meth_colors,guide=FALSE) + xlab("Human") + ylab("Mouse") + scale_x_discrete(labels=as.vector(apply(state_freq,1,function(x) paste(x[1],"\n(",round(as.numeric(x[2]),0),"%)",sep=""))))

state_freq_chromHMM = ddply(human_mouse_orthologs_chromHMM_paired,.(Human_state_chromHMM),summarise,Entries=100*length(Human_state_chromHMM)/dim(human_mouse_orthologs_chromHMM_paired)[1])

c = ggplot(human_mouse_orthologs_chromHMM_paired,aes(x=Human_state_chromHMM,fill=Mouse_state_chromHMM)) + geom_bar(position="fill") + xlab("Human") + ylab("Mouse") + theme(axis.text.x = element_text(angle=90,hjust=1),legend.direction="horizontal") + guides(fill=guide_legend(title.position="top")) + scale_fill_discrete(name="Mouse state") + scale_x_discrete(labels=as.vector(apply(state_freq_chromHMM,1,function(x) paste(x[1],"\n(",round(as.numeric(x[2]),1),"%)",sep="")))) 

d = ggplot(hg19_mm10_TE_WGBS_subfamily_hypo_paired,aes(x=Human_hypo,y=Mouse_hypo,color=Anatomy,shape=Age)) + geom_point() + scale_color_manual(values=anatomy_colors,guide=FALSE) + xlab("Human") + ylab("Mouse") + geom_abline(slope=1,linetype="dotted") + geom_smooth(aes(linetype=Age),method='lm',fullrange=TRUE,alpha=0.1) + xlim(0,0.4) + ylim(0,0.4) + guides(color=FALSE,shape=FALSE,linetype=FALSE)

e = ggplot(hg19_mm10_chromHMM_subfamily[which(hg19_mm10_chromHMM_subfamily$Human_state_chromHMM == "1_TssA" & hg19_mm10_chromHMM_subfamily$Mouse_state_chromHMM == "TssA"),],aes(x=Percent.x,y=Percent.y,color=Anatomy,shape=Age)) + geom_point() + scale_color_manual(values=anatomy_colors,guide=FALSE) + xlab("Human") + ylab("Mouse") + geom_abline(slope=1,linetype="dotted") + geom_smooth(aes(linetype=Age),method='lm',fullrange=TRUE,alpha=0.1) + xlim(0,0.05) + ylim(0,0.05) + guides(color=FALSE,shape=FALSE,linetype=FALSE)

f = ggplot(hg19_mm10_chromHMM_subfamily_active,aes(x=Percent.x,y=Percent.y,color=Anatomy,shape=Age)) + geom_point() + scale_color_manual(values=anatomy_colors,guide=FALSE) + xlab("Human") + ylab("Mouse") + geom_abline(slope=1,linetype="dotted") + geom_smooth(aes(linetype=Age),method='lm',fullrange=TRUE,alpha=0.1) + xlim(0,0.4) + ylim(0,0.4) + guides(color=FALSE,shape=FALSE,linetype=FALSE)
...
grid.arrange(a,b,c,d,e,f,legend,nrow=4,layout_matrix=rbind(c(1,2,2),c(3,3,3),c(4,5,6),c(7,7,7)),heights=c(0.3,0.3,0.3,0.1))
```
...
pie(rmsk_TE_class$Mouse_orthologs,labels=paste(rmsk_TE_class$Mouse_orthologs,"(",round(rmsk_TE_class$Mouse_orthologs/sum(rmsk_TE_class$Mouse_orthologs)*100,0),"%)",sep=""),col=class_colors[as.vector(rmsk_TE_class$class_update)],clockwise=TRUE,main="Orthologous TEs",cex=1,cex.main=1,line=-5,radius=0.5)

pie(rmsk_TE_class$Mouse_ortholog_subfamily,labels=paste(rmsk_TE_class$Mouse_ortholog_subfamily,"(",round(rmsk_TE_class$Mouse_ortholog_subfamily/sum(rmsk_TE_class$Mouse_ortholog_subfamily)*100,0),"%)",sep=""),col=class_colors[as.vector(rmsk_TE_class$class_update)],clockwise=TRUE,main="Orthologous subfamilies",cex=1,cex.main=1,line=-5,radius=0.5)

a = ggplot(human_mouse_spearman,aes(x=Test,y=Correlation,fill=Tissue.Age)) + geom_boxplot() + ylab("Spearman correlation") + theme(axis.title.x = element_blank()) + scale_x_discrete(labels=c("Human-human","Mouse-mouse","Human-mouse")) + scale_y_continuous(limits=c(0,1)) + scale_fill_discrete(guide=FALSE)

b = ggplot(human_mouse_spearman_subfamily,aes(x=Test,y=Correlation,fill=Tissue.Age)) + geom_boxplot() + ylab("Spearman correlation") + theme(axis.title.x = element_blank()) + scale_x_discrete(labels=c("Human-human","Mouse-mouse","Human-mouse")) + scale_y_continuous(limits=c(0,1)) + scale_fill_discrete(guide=FALSE)

c = ggplot(human_mouse_spearman_subfamily_TssA,aes(x=Test,y=Correlation,fill=Tissue.Age)) + geom_boxplot() + ylab("Spearman correlation") + theme(axis.title.x = element_blank()) + scale_x_discrete(labels=c("Human-human","Mouse-mouse","Human-mouse")) + scale_y_continuous(limits=c(0,1)) + scale_fill_discrete(guide=FALSE)

d = ggplot(human_mouse_spearman_subfamily_active,aes(x=Test,y=Correlation,fill=Tissue.Age)) + geom_boxplot() + ylab("Spearman correlation") + theme(axis.title.x = element_blank()) + scale_x_discrete(labels=c("Human-human","Mouse-mouse","Human-mouse")) + scale_y_continuous(limits=c(0,1)) + scale_fill_discrete(guide=FALSE)
...
grid.arrange(a,b,c,d,legend,nrow=3,layout_matrix=rbind(c(1,2),c(3,4),c(5,5)),heights=c(0.45,0.45,0.1))
```
...
dim(merge(TE_meth_average[,c(TE_coordinates,"CpGs")],unique(human_mouse_orthologs_mm10[,hg19_coordinates]),by.x=TE_coordinates[c(1:4,6,5,7)],by.y=hg19_coordinates))
dim(merge(TE_meth_average[,c(TE_coordinates,"CpGs")],unique(human_mouse_orthologs_mm10[,hg19_coordinates]),by.x=TE_coordinates[c(1:4,6,5,7)],by.y=hg19_coordinates))[1]/dim(unique(human_mouse_orthologs_mm10[,hg19_coordinates]))[1]

# Average number of CpGs per hg19 ortholog with CpGs
median(merge(TE_meth_average[,c(TE_coordinates,"CpGs")],unique(human_mouse_orthologs_mm10[,hg19_coordinates]),by.x=TE_coordinates[c(1:4,6,5,7)],by.y=hg19_coordinates)$CpGs)

# Number, % of mm10 TEs with CpGs
dim(mm10_rmsk_TE_WGBS)[1]
dim(mm10_rmsk_TE_WGBS)[1]/MOUSE_TE

# Number, % of mm10 orthologs with CpGs
dim(merge(mm10_rmsk_TE_WGBS,unique(human_mouse_orthologs_mm10[,mm10_coordinates]),by.x=TE_coordinates[c(1:4,6,5,7)],by.y=mm10_coordinates))
dim(merge(mm10_rmsk_TE_WGBS,unique(human_mouse_orthologs_mm10[,mm10_coordinates]),by.x=TE_coordinates[c(1:4,6,5,7)],by.y=mm10_coordinates))[1]/dim(unique(human_mouse_orthologs_mm10[,mm10_coordinates]))[1]
...
# All methylation states, overall and by sample
...
dim(unique(human_mouse_orthologs_WGBS_hypo[,c(hg19_coordinates,"Human_sample")]))
dim(unique(human_mouse_orthologs_WGBS_hypo[,c(mm10_coordinates,"Mouse_sample_WGBS")]))
```
...
table(hg19_orthologs_chromHMM$Human_state_chromHMM)
table(hg19_orthologs_chromHMM$Human_state_chromHMM)/dim(hg19_orthologs_chromHMM)[1]
table(mm10_orthologs_chromHMM$Mouse_state_chromHMM)
table(mm10_orthologs_chromHMM$Mouse_state_chromHMM)/dim(mm10_orthologs_chromHMM)[1]
...
# Filter to matched states
human_mouse_orthologs_chromHMM_paired_matched = merge(human_mouse_orthologs_chromHMM_paired,human_mouse_chromHMM_states,by=c("Human_state_chromHMM","Mouse_state_chromHMM"))

# Number of pairs and human/mouse TEs per state
ddply(human_mouse_orthologs_chromHMM_paired_matched,.(Human_state_chromHMM),function(x) dim(x)[1])
ddply(human_mouse_orthologs_chromHMM_paired_matched,.(Human_state_chromHMM),function(x) dim(unique(x[,hg19_coordinates]))[1])
ddply(human_mouse_orthologs_chromHMM_paired_matched,.(Human_state_chromHMM),function(x) dim(unique(x[,c(hg19_coordinates,"Human_sample")]))[1])
ddply(human_mouse_orthologs_chromHMM_paired_matched,.(Human_state_chromHMM),function(x) dim(unique(x[,mm10_coordinates]))[1])
ddply(human_mouse_orthologs_chromHMM_paired_matched,.(Human_state_chromHMM),function(x) dim(unique(x[,c(mm10_coordinates,"Mouse_sample_chromHMM")]))[1])

# hg19 TE class per state
ddply(human_mouse_orthologs_chromHMM_paired_matched,.(Human_state_chromHMM),function(x) table(unique(x[,hg19_coordinates])$human_class))

# hg19 TE subfamily per state
human_mouse_orthologs_chromHMM_subfamily = melt(ddply(human_mouse_orthologs_chromHMM_paired_matched,.(Human_state_chromHMM),function(x) table(unique(x[,hg19_coordinates])$human_subfamily)),id.var="Human_state_chromHMM")
human_mouse_orthologs_chromHMM_subfamily = merge(human_mouse_orthologs_chromHMM_subfamily,rmsk_TE_subfamily[,c("subfamily","Count")],by.x="variable",by.y="subfamily")
human_mouse_orthologs_chromHMM_subfamily = human_mouse_orthologs_chromHMM_subfamily[which(human_mouse_orthologs_chromHMM_subfamily$value > 0),]

ddply(human_mouse_orthologs_chromHMM_subfamily,.(Human_state_chromHMM),function(x) x[order(x$value/x$Count),])
...
## 7_Enh
ddply(human_mouse_spearman_subfamily_Enh,.(Test),summarise,Median=median(Correlation),IQR=IQR(Correlation))
pairwise.wilcox.test(human_mouse_spearman_subfamily_Enh$Correlation,human_mouse_spearman_subfamily_Enh$Test)
by(human_mouse_spearman_subfamily_Enh,human_mouse_spearman_subfamily_Enh$Test,function(x) pairwise.wilcox.test(x$Correlation,x$Tissue.Age))
```
