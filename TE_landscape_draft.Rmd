...
# Total widths
CHROMHMM_TOTAL_WIDTH = 121*GENOME_WIDTH + 6*GENOME_WIDTH_noY
DNASE_TOTAL_WIDTH = 47*GENOME_WIDTH + 6*GENOME_WIDTH_noY
H3K27AC_TOTAL_WIDTH = 92*GENOME_WIDTH + 6*GENOME_WIDTH_noY
...
# Total widths
CHROMHMM_TE_WIDTH = 121*MERGED_TE_WIDTH + 6*MERGED_TE_WIDTH_noY
DNASE_TE_WIDTH = 47*MERGED_TE_WIDTH + 6*MERGED_TE_WIDTH_noY
H3K27AC_TE_WIDTH = 92*MERGED_TE_WIDTH + 6*MERGED_TE_WIDTH_noY
...
# Samples with each metric, no Y
apply(metadata[,c(1,10:13)],2,function(x) dim(metadata[which(!is.na(x) & metadata$chrY == "No"),])[1])
```
