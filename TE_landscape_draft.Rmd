...
d = ggplot(sample_chromHMM_tsne,aes(x=V1,y=V2,color=Anatomy)) + geom_point() + scale_color_manual(values=anatomy_colors,guide=FALSE) + xlab("Axis 1") + ylab("Axis 2") + theme(aspect.ratio = 1)
e = ggplot(sample_chromHMM_tsne,aes(x=V1,y=V2,color=Type)) + geom_point() + scale_color_manual(values=type_colors,guide=FALSE) + xlab("Axis 1") + ylab("Axis 2") + theme(aspect.ratio = 1)
f = ggplot(sample_chromHMM_tsne,aes(x=V1,y=V2,color=Germline)) + geom_point() + scale_color_manual(values=germline_colors,guide=FALSE) + xlab("Axis 1") + ylab("Axis 2") + theme(aspect.ratio = 1)
g = ggplot(sample_chromHMM_tsne,aes(x=V1,y=V2,color=Cancer)) + geom_point() + scale_color_manual(values=cancer_colors,guide=FALSE) + xlab("Axis 1") + ylab("Axis 2") + theme(aspect.ratio = 1)

## Subfamilies
h = ggplot(subfamily_WGBS_tsne,aes(x=V1,y=V2,color=class_update,shape=family)) + geom_point() + scale_color_manual(values=class_colors,guide=FALSE) + scale_shape_manual(values=family_shapes,guide=FALSE)+ xlab("Axis 1") + ylab("Axis 2") + theme(aspect.ratio = 1)
i = ggplot(subfamily_DNase_tsne,aes(x=V1,y=V2,color=class_update,shape=family)) + geom_point() + scale_color_manual(values=class_colors,guide=FALSE) + scale_shape_manual(values=family_shapes,guide=FALSE)+ xlab("Axis 1") + ylab("Axis 2") + theme(aspect.ratio = 1)
j = ggplot(subfamily_H3K27ac_tsne,aes(x=V1,y=V2,color=class_update,shape=family)) + geom_point() + scale_color_manual(values=class_colors,guide=FALSE) + scale_shape_manual(values=family_shapes,guide=FALSE)+ xlab("Axis 1") + ylab("Axis 2") + theme(aspect.ratio = 1)
...
```{r Fig S17, echo=FALSE, cache=TRUE, cache.lazy=FALSE}
...
grid.arrange(a,b,heights=c(0.53,0.2))
```
