...
```{r shuffled replicate analysis}
source("R_scripts/replicate_matrices_shuffled.R")
```

### Supplementary Figure NEW (orthogonal)

```{r create orthogonal sets}
source("R_scripts/orthogonal_sets.R")
```
...
source("R_scripts/orthogonal_vista.R")
```
...
source("R_scripts/orthogonal_homer.R")
```
