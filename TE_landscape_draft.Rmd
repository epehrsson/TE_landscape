...
```{bash orphan code, eval=FALSE}
# RefSeq features, coding	 
#genic_features/refseq_[feature]_pc.txt [6 files]	
...
#genic_features/refseq_[feature]_nc.txt [5 files]	
...
# QC for individual summit overlap
...
# WGBS - average methylation over all CpGs
