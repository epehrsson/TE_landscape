...
correlate_subfamily = ldply(c(cohorts,standard_chromosomes[1:24],measure_metrics_subfam),function(x) correlate_spearman(rmsk_TE_subfamily_measure,x,all_pc_states))
correlate_subfamily$Metric = rep(c(cohorts,standard_chromosomes[1:24],measure_metrics_subfam),each=7*length(all_pc_states))
correlate_subfamily$Metric = factor(correlate_subfamily$Metric,levels=c(cohorts,standard_chromosomes[1:24],measure_metrics_subfam))
