...
# Intersect TEs and exons with RNA-seq bedfiles
...
```{bash shuffled chromHMM max intra, eval=FALSE}
...
```{bash shuffled DHS matrix, eval=FALSE}
...
```{bash shuffled H3K27ac matrix, eval=FALSE}
#TE_landscape/features/shuffled_TEs/run_intersect.sh
...
```{bash merge subfamilies, eval=FALSE}
...
```{r calculate TE stats, cache=TRUE}
