...
## and the mean proprotion of samples a TE is in the state (columns)
...
# Creates labels listing the number of samples per technique 
...
## Output
#/scratch/ecp/TE_landscape/RNA/rmsk_TEother.txt.sorted_E#_average.txt [56 files]
...
## Output
#/scratch/ecp/TE_landscape/RNA/refseq_exons_unique.txt.sorted_E#_average.txt [56 files]
...
## Output
#/scratch/ecp/TE_landscape/state18/rmsk_TEother_summit_E#.txt [98 files]
...
## Output
#/scratch/ecp/TE_landscape/state18/rmsk_TEother_majority_E#.txt [98 files]
...
## Output
#/scratch/ecp/TE_landscape/state18/rmsk_TEother_18state.txt
...
## Output
#/scratch/ecp/TE_landscape/state50/rmsk_TEother_summit_windows_50state_E#.txt [7 files]
...
## Output
#/scratch/ecp/TE_landscape/state50/rmsk_TEother_majority_E#_50_segments.txt [7 files]
...
## Output
#/scratch/ecp/TE_landscape/state50/rmsk_TEother_50state_E#.txt [7 files]
#/scratch/ecp/TE_landscape/state50/rmsk_TEother_50state_E#_sorted.txt [7 files]
```
...
## Output
#/scratch/ecp/TE_landscape/state50/state_sample_counts_rmsk_TEother_50state_E#.txt [7 files]
```
...
## Output
#/scratch/ecp/TE_landscape/state50/count_active.txt
```
...
## Output
#/scratch/ecp/TE_landscape/combine_marks/true_summit/count_active.txt
```
...
#/scratch/ecp/TE_landscape/combine_marks/true_summit/E# [127 files]
...
# Potential
a = ggplot(subfam_states,aes(x=States)) + geom_histogram(binwidth=1,fill="black") + ylab("Subfamilies") + xlab("Number of states") + facet_wrap(~Metric,scales="free_x",nrow=1,labeller=labeller(Metric=mark_labels_simple)) + scale_y_continuous(limits=c(0,968)) + expand_limits(x=0)
...
## Output
#/scratch/ecp/TE_landscape/state50/subfamily_state_sample_rmsk_TEother_50state_E#.txt [7 files]
...
## Output
#/scratch/ecp/TE_landscape/state50/MER121_E017_7_Enh.txt
