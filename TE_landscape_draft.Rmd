...
# WGBS states
a = ggplot(TE_meth_average,aes(x=States)) + geom_histogram(aes(y = ..density..),binwidth=1,fill="blue",color="grey",alpha=0.5) + ylab("Proportion of TEs") + xlab("Number of methylation states") + scale_y_continuous(limits=c(0,1))

# WGBS states by class
b = ggplot(TE_meth_average,aes(x=States)) + geom_histogram(aes(y = ..density..),binwidth=1,fill="blue",color="grey",alpha=0.5) + xlab("Number of methylation states") + ylab("Proportion of TEs") + facet_wrap(~class_update) + scale_y_continuous(limits=c(0,1)) 
...
c = ggplot(great[which(great$set == "AmnSINE1_7_Enh"),],aes(x=rev(reorder(`Term Name`,`Binom Raw P-Value`,median)),y=log10(`Binom Raw P-Value`),label=`Binom Raw P-Value`)) + geom_bar(stat="identity") + coord_flip() + theme(axis.title.x = element_blank(),axis.title.y = element_blank(),plot.title = element_text(hjust = 1),axis.text=element_text(size=7)) 

d = ggplot(great[which(great$set == "AmnSINE2_DNase"),],aes(x=rev(reorder(`Term Name`,`Binom Raw P-Value`,median)),y=log10(`Binom Raw P-Value`),label=`Binom Raw P-Value`)) + geom_bar(stat="identity") + coord_flip() + theme(axis.title.x = element_blank(),axis.title.y = element_blank(),plot.title = element_text(hjust = 1),axis.text=element_text(size=7))

e = ggplot(great[which(great$set == "MER121_7_Enh"),],aes(x=rev(reorder(`Term Name`,`Binom Raw P-Value`,median)),y=log10(`Binom Raw P-Value`),label=`Binom Raw P-Value`)) + geom_bar(stat="identity") + coord_flip() + theme(axis.title.x = element_blank(),axis.title.y = element_blank(),plot.title = element_text(hjust = 1),axis.text=element_text(size=7)) 

f = ggplot(great[which(great$set == "MER131_DNase"),],aes(x=rev(reorder(`Term Name`,`Binom Raw P-Value`,median)),y=log10(`Binom Raw P-Value`),label=`Binom Raw P-Value`)) + geom_bar(stat="identity") + coord_flip() + theme(axis.title.x = element_blank(),axis.title.y = element_blank(),plot.title = element_text(hjust = 1),axis.text=element_text(size=7))
