...
intersect_Roadmap.sh (old version)
# Intersect with Roadmap data
# 4/19/2016, 4/25/2016, 5/3/2016, 5/5/2016, 5/19/2016,
# 1/26/2017, 2/2/2017, 2/3/2017, 2/6/2017, 2/8/2017, 3/2/2017, 3/6/2017, 5/8/2017, 5/10/2017, 5/11/2017, 5/22/2017, 5/29/2017, 5/30/2017, 5/31/2017, 6/5/2017, 6/12/2017, 6/15/2017, 6/19/2017, 7/4/2017
# 8/2/2017, 8/4/2017, 8/5/2017, 8/7/2017, 8/18/2017, 8/25/2017, 8/28/2017, 8/29/2017
...
# Features
# Merged genic features
#TE_landscape/chromHMM/Refseq_features/intersect/chromHMM_CDS.bed
for file in chromHMM_bedfiles/E*.bed; do suffix=$(basename $file | cut -d '_' -f1); bedtools intersect -wo -a ../genic_features/refseq_coding_exon_merge.txt -b $file | awk -v OFS='\t' -v sample=$suffix '{print $0, sample}' - >> chromHMM_features/chromHMM_CDS.bed; done
#TE_landscape/chromHMM/Refseq_features/intersect/chromHMM_3UTR.bed
for file in chromHMM_bedfiles/E*.bed; do suffix=$(basename $file | cut -d '_' -f1); bedtools intersect -wo -a ../genic_features/refseq_3UTR_merge.txt -b $file | awk -v OFS='\t' -v sample=$suffix '{print $0, sample}' - >> chromHMM_features/chromHMM_3UTR.bed; done
#TE_landscape/chromHMM/Refseq_features/intersect/chromHMM_5UTR.bed
for file in chromHMM_bedfiles/E*.bed; do suffix=$(basename $file | cut -d '_' -f1); bedtools intersect -wo -a ../genic_features/refseq_5UTR_merge.txt -b $file | awk -v OFS='\t' -v sample=$suffix '{print $0, sample}' - >> chromHMM_features/chromHMM_5UTR.bed; done
#TE_landscape/chromHMM/Refseq_features/intersect/chromHMM_exon.bed
for file in chromHMM_bedfiles/E*.bed; do suffix=$(basename $file | cut -d '_' -f1); bedtools intersect -wo -a ../genic_features/refseq_exons_merge.txt -b $file | awk -v OFS='\t' -v sample=$suffix '{print $0, sample}' - >> chromHMM_features/chromHMM_exon.bed; done
#TE_landscape/chromHMM/Refseq_features/intersect/chromHMM_intron.bed
for file in chromHMM_bedfiles/E*.bed; do suffix=$(basename $file | cut -d '_' -f1); bedtools intersect -wo -a ../genic_features/refseq_introns_merge.txt -b $file | awk -v OFS='\t' -v sample=$suffix '{print $0, sample}' - >> chromHMM_features/chromHMM_intron.bed; done
#TE_landscape/chromHMM/Refseq_features/intersect/chromHMM_promoter.bed
for file in chromHMM_bedfiles/E*.bed; do suffix=$(basename $file | cut -d '_' -f1); bedtools intersect -wo -a ../genic_features/refseq_promoters_merge.txt -b $file | awk -v OFS='\t' -v sample=$suffix '{print $0, sample}' - >> chromHMM_features/chromHMM_promoter.bed; done
#TE_landscape/chromHMM/Refseq_features/intersect/chromHMM_refseq_intergenic.txt
